...
class ChecklistController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreChecklistsRequest $request, ChecklistGroup $checklistGroup)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreChecklistsRequest $request, ChecklistGroup $checklistGroup, Checklist $checklist)
    {
